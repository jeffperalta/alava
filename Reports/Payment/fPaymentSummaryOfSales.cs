...
{
    public partial class fPaymentSummaryOfSales : Form
    {
        public fPaymentSummaryOfSales()
        {
            InitializeComponent();
        }
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            crystalReportViewer1.ReportSource = Program.MainLogInPage.ReportLocation + "PaymentSummaryOfSalesReport.rpt";

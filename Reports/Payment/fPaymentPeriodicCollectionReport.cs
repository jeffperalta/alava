...
{
    public partial class fPaymentPeriodicCollectionReport : Form
    {
        public fPaymentPeriodicCollectionReport()
        {
            InitializeComponent();
        }
        ...
        private void btnRefresh_Click(object sender, EventArgs e)
        {
            ...
            crystalReportViewer1.ReportSource = Program.MainLogInPage.ReportLocation + "PeriodicCollectionReport.rpt";

            ParameterDate1.Name = "Date1";
            ParamValueDate1.Value = dtpStartDate.Value.Date;
            ParameterDate1.CurrentValues.Add(ParamValueDate1);
            Parameters.Add(ParameterDate1);

            ParameterDate2.Name = "Date2";
            ParamValueDate2.Value = dtpEndDate.Value.Date;
